...
export default function ImageEditor({
  ...
  return (
    <div className="fixed w-screen h-screen left-0 top-0 bg-black bg-opacity-75 z-20 flex items-center justify-center">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <div
            className={`cursor-pointer py-1 px-4 rounded-full text-black ${
              settings.sensitive ? "bg-red-500 text-white" : "bg-white"
            }`}
